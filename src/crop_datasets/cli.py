...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_common_args(parser: argparse.ArgumentParser) -> None:
        parser.add_argument("--root", default="./data", help="Dataset storage root (default: ./data)")
        parser.add_argument("--manifest", default=str(default_manifest_path()), help="Path to datasets manifest")
